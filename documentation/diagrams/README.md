...
### 5. Диаграмма развертываний<a name="5"></a>
Диаграмма развертываний представляет собой следующую диаграмму: 

![Диаграмма развертываний](https://github.com/Archeex/itNotes/blob/master/documentation/diagrams/images/DeploymentDiagram.png)
